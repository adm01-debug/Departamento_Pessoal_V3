...
| `REPORT_SCHEDULER_SECRET`          | env de `processar-agendamentos` e `enviar-relatorio`                                 | autentica somente o salto interno de entrega de relatórios | Semestral ou sob suspeita                     |
