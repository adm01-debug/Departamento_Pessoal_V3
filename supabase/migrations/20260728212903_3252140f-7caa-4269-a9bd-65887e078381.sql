-- ---------------------------------------------------------------------------
-- registrar_batida_ponto (correção 2/2)
--
-- Além do selo vindo do cliente (corrigido na migração anterior), a função
-- referenciava as colunas audit_sha256 e audit_conformidade, que NÃO EXISTEM
-- em public.batidas_ponto. Ou seja: o registro de ponto pela web nunca
-- chegou a funcionar — falhava em tempo de execução no INSERT.
-- Colunas reais conferidas em information_schema antes desta correção.
-- ---------------------------------------------------------------------------
...
BEGIN
  ...
  INSERT INTO public.batidas_ponto (
    ...
    dentro_raio, timezone, foto_biometria_url, metadata
