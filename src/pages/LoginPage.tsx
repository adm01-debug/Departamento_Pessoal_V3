...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errObj: Record<string, unknown> = err && typeof err === 'object' ? (err as Record<string, unknown>) : {};
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    setError('');
    try {
      // O limite autoritativo é aplicado pelo endpoint de Auth. A antiga RPC
      // aceitava o IP literal "client" enviado pelo navegador, portanto não
      // limitava o IP real e ainda expunha uma SECURITY DEFINER sem sessão.
                ...
                {mfaPending ? (
                  <form onSubmit={handleMfaSubmit} className="space-y-5">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="totp" className="font-body text-sm font-medium">
                    ...
                    {forgotMode ? (
                      forgotSent ? (
                        ...
                        <form onSubmit={handleForgotPassword} className="space-y-5">
                          <div className="space-y-2">
                            <Label htmlFor="forgot-email" className="font-body text-sm font-medium">
                              Email
                            </Label>
                      ...
                      <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        {lockState.isLocked && <LockoutMessage remainingSeconds={lockState.remainingSeconds} />}
