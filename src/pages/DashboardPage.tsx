  ...
  return useQuery<Pendencia[]>({
    ...
    queryFn: async () => {
      ...
      if (feriasPendentes && feriasPendentes > 0)
        pendencias.push({
          tipo: 'ferias',
          descricao: `${feriasPendentes} férias pendentes`,
      ...
      if (afastamentosAtivos && afastamentosAtivos > 0)
        pendencias.push({
          tipo: 'afastamentos',
          descricao: `${afastamentosAtivos} afastamentos ativos`,
      ...
      if (admissoesPendentes && admissoesPendentes > 0)
        pendencias.push({
          tipo: 'admissoes',
          descricao: `${admissoesPendentes} admissões em curso`,
          quantidade: admissoesPendentes,
          icone: 'admissoes',
        });
      if (assinaturasPendentes && assinaturasPendentes > 0)
        pendencias.push({
          tipo: 'assinaturas',
          descricao: `${assinaturasPendentes} assinaturas pendentes`,
          quantidade: assinaturasPendentes,
          icone: 'assinaturas',
        });
      if (pontoPendente && pontoPendente > 0)
        pendencias.push({
          tipo: 'ponto',
          descricao: `${pontoPendente} ajustes de ponto`,
          quantidade: pontoPendente,
          icone: 'ponto',
        });
  ...
  const steps = [
    {
      ...
      desc: 'Configure os dados da sua empresa',
      icon: Building2,
      path: '/empresas/nova',
    ...
    },
    {
      ...
      desc: 'Cadastre seus primeiros funcionários',
      icon: UserPlus,
    ...
    },
    {
      ...
      desc: 'Execute o primeiro cálculo de folha',
      icon: DollarSign,
      path: '/folha',
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
            {steps.map((s, i) => (
              ...
              >
                ...
                <div
                  className={cn(
                    'p-4 rounded-2xl bg-gradient-to-br mb-4 shadow-lg group-hover:scale-110 transition-transform',
                    s.gradient
                  )}
                >
    ...
    <div className="space-y-6 max-w-[1400px] mx-auto pb-10">
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        {loadingStats ? (
          Array(4)
            .fill(0)
            .map((_, i) => <KPICardSkeleton key={i} index={i} />)
        ) : (
          <>
            <MetricCard
      ...
      {!isEmptySystem && (
        <div className="grid gap-4 grid-cols-1 lg:grid-cols-5">
          <div className="lg:col-span-3">
            <MorningBriefing empresaId={empresaAtualId || undefined} />
          </div>
