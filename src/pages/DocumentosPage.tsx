...
export default function DocumentosPage() {
  ...
  const [colaboradorFilter, setColaboradorFilter] = useSyncedState(urlColaboradorId, (id) => id || 'todos');
  ...
  return (
    <>
      ...
      >
              ...
              <TableBody>
                {filtered.map((doc: any) => (
                  <TableRow key={doc.id} className="hover:bg-accent/30 transition-colors">
                    ...
                    <TableCell>
                      <Badge className="bg-info/15 text-info border-0 font-body text-[10px]">{doc.tipo || '-'}</Badge>
                    </TableCell>
                    ...
                    <TableCell className="text-right">
                      <div className="flex gap-1">
                        ...
                        <Button
                          variant="ghost"
                          size="icon"
                          className="rounded-xl hover:bg-info/10"
                        ...
                        <Button
                          variant="ghost"
                          size="icon"
                          className="rounded-xl hover:bg-success/10"
                          onClick={() => setSelectedDocForTimeline(doc)}
                          title="Histórico"
                        >
        ...
        {/* OCR Dialog */}
        <Dialog
          open={!!selectedDocForOcr}
          onOpenChange={(o) => {
            if (!o) setSelectedDocForOcr(null);
          }}
        >
          <DialogContent className="max-w-md rounded-2xl">
            ...
            <DialogFooter>
              <Button variant="outline" onClick={() => setSelectedDocForOcr(null)} className="rounded-xl">
                Fechar
              </Button>
            </DialogFooter>
          </DialogContent>
        ...
        {/* Timeline Dialog */}
        <Dialog
          open={!!selectedDocForTimeline}
          onOpenChange={(o) => {
            if (!o) setSelectedDocForTimeline(null);
          }}
        >
          <DialogContent className="max-w-md rounded-2xl">
            <DialogHeader>
            ...
            <DialogFooter>
              <Button variant="outline" onClick={() => setSelectedDocForTimeline(null)} className="rounded-xl">
                Fechar
              </Button>
            </DialogFooter>
          </DialogContent>
        ...
        <Dialog open={showUpload} onOpenChange={setShowUpload}>
          <DialogContent className="rounded-2xl">
            ...
            <DialogFooter>
              <Button variant="outline" onClick={() => setShowUpload(false)} className="rounded-xl">
                Cancelar
              </Button>
              <Button
