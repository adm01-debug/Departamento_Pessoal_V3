    ...
    <div className="space-y-4 font-body">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card className="border-primary/20 shadow-xs bg-primary/5">
          <CardContent className="p-4 flex items-start gap-3">
            ...
            <div>
              <Label className="text-[10px] uppercase text-primary font-medium tracking-wider">Vigência da Alteração</Label>
      ...
      <div className="p-4 rounded-xl border border-primary/10 bg-primary/5">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-xs font-medium uppercase tracking-widest text-primary">Detalhamento das Mudanças</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="space-y-1">
            ...
            <p className="text-sm font-medium text-primary">{dados.vrSalFx ? formatCurrency(dados.vrSalFx) : '-'}</p>
