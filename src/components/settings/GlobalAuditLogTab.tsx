          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <CardDescription className="font-body">
                Trilha completa de alterações e execuções em todo o sistema
              </CardDescription>
            </div>
      ...
      <div className="bg-primary/5 p-4 rounded-2xl border border-primary/10 flex items-start gap-3">
        ...
        <div className="space-y-1">
          ...
          <p className="text-[10px] text-muted-foreground leading-relaxed">
            Esta trilha de auditoria é imutável e registra todas as operações sensíveis do sistema. Em caso de
            fiscalização, os dados aqui apresentados servem como prova de integridade dos processos de Folha e Ponto.
          </p>
        </div>
      </div>
    </motion.div>
