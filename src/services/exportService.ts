...
export const validateExportData = (data: Record<string, unknown>[]) => {
...
export const exportPontoCSV = (data: Record<string, unknown>[], filename = 'registros-ponto.csv') => {
  try {
...
export const exportPortaria671PDF = (solicitacao: Portaria671Solicitacao) => {
  try {
    const doc = new jsPDF() as JsPdfWithAutoTable;
    ...
    const adjustmentData = [
      ...
      ['Hora Sugerida', solicitacao.hora_sugerida || 'N/A'],
